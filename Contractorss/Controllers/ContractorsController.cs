...
namespace Contractorss.Models
{
    public class ContractorsController : Controller
    {
        ...
        {
            IQueryable<Contractor> contractors = _context.Contractors;
            int pageSize = 10;
            

         
            var count = await contractors.CountAsync();
            var items = await contractors.Skip((page - 1) * pageSize).Take(pageSize).ToListAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContractorId,NameCompany")] Contractor contractor)
        {
