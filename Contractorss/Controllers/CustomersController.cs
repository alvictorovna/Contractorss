...
namespace Contractorss.Models
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ContractorsContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,CompanyName,NameCeo,SurnameCeo")] Customer customer)
        {
